...
# 注册接口
@main_bp.route("/pythoncb7g1i62/news/register", methods=['POST'])
def pythoncb7g1i62_news_register():
...
# 登录接口
@main_bp.route("/pythoncb7g1i62/news/login", methods=['GET','POST'])
def pythoncb7g1i62_news_login():
...
# 登出接口
@main_bp.route("/pythoncb7g1i62/news/logout", methods=['POST'])
def pythoncb7g1i62_news_logout():
    if request.method == 'POST':
        msg = {
            "msg": "退出成功",
            "code": 0
...
# 重置密码接口
@main_bp.route("/pythoncb7g1i62/news/resetPass", methods=['POST'])
def pythoncb7g1i62_news_resetpass():
    '''
    '''
    if request.method == 'POST':
...
# 获取会话信息接口
@main_bp.route("/pythoncb7g1i62/news/session", methods=['GET'])
def pythoncb7g1i62_news_session():
    '''
    '''
...
# 分类接口（后端）
@main_bp.route("/pythoncb7g1i62/news/page", methods=['GET'])
def pythoncb7g1i62_news_page():
    '''
    '''
    if request.method == 'GET':
...
# 排序接口
@main_bp.route("/pythoncb7g1i62/news/autoSort", methods=['GET'])
def pythoncb7g1i62_news_autosort():
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success",  "data":{"currPage":1,"totalPage":1,"total":1,"pageSize":10,"list":[]}}
...
#查询单条数据
@main_bp.route("/pythoncb7g1i62/news/query", methods=['GET'])
def pythoncb7g1i62_news_query():
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success",  "data":{}}
        req_dict = session.get("req_dict")
...
# 分页接口（前端）
@main_bp.route("/pythoncb7g1i62/news/list", methods=['GET'])
def pythoncb7g1i62_news_list():
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success",  "data":{"currPage":1,"totalPage":1,"total":1,"pageSize":10,"list":[]}}
...
# 保存接口（后端）
@main_bp.route("/pythoncb7g1i62/news/save", methods=['POST'])
def pythoncb7g1i62_news_save():
    '''
    '''
    request.operation = "新增超市公告"
    if request.method == 'POST':
        msg = {"code": normal_code, "msg": "success", "data": {}}
        req_dict = session.get("req_dict")
        for key in req_dict:
...
# 添加接口（前端）
@main_bp.route("/pythoncb7g1i62/news/add", methods=['POST'])
def pythoncb7g1i62_news_add():
    '''
    '''
    request.operation = "新增超市公告"
    if request.method == 'POST':
...
# 踩、赞接口
@main_bp.route("/pythoncb7g1i62/news/thumbsup/<id_>", methods=['GET'])
def pythoncb7g1i62_news_thumbsup(id_):
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 获取详情信息（后端）
@main_bp.route("/pythoncb7g1i62/news/info/<id_>", methods=['GET'])
def pythoncb7g1i62_news_info(id_):
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 获取详情信息（前端）
@main_bp.route("/pythoncb7g1i62/news/detail/<id_>", methods=['GET'])
def pythoncb7g1i62_news_detail(id_):
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 更新接口
@main_bp.route("/pythoncb7g1i62/news/update", methods=['POST'])
def pythoncb7g1i62_news_update():
    '''
    '''
    request.operation = "更新超市公告"
    if request.method == 'POST':
        msg = {"code": normal_code, "msg": "success", "data": {}}
        req_dict = session.get("req_dict")
...
# 删除接口
@main_bp.route("/pythoncb7g1i62/news/delete", methods=['POST'])
def pythoncb7g1i62_news_delete():
    '''
    '''
    request.operation = "删除超市公告"
    if request.method == 'POST':
        msg = {"code": normal_code, "msg": "success", "data": {}}
        req_dict = session.get("req_dict")
...
# 投票接口
@main_bp.route("/pythoncb7g1i62/news/vote/<int:id_>", methods=['POST'])
def pythoncb7g1i62_news_vote(id_):
    '''
    '''
    if request.method == 'POST':
        msg = {"code": normal_code, "msg": "success"}
...
# 分组统计接口
@main_bp.route("/pythoncb7g1i62/news/group/<columnName>", methods=['GET'])
def pythoncb7g1i62_news_group(columnName):
    '''
    分组统计接口
    '''
    if request.method == 'GET':
...
# 按值统计接口
@main_bp.route("/pythoncb7g1i62/news/value/<xColumnName>/<yColumnName>", methods=['GET'])
def pythoncb7g1i62_news_value(xColumnName, yColumnName):
    '''
    按值统计接口,
    {
        "code": 0,
...
# 按日期统计接口
@main_bp.route("/pythoncb7g1i62/news/value/<xColumnName>/<yColumnName>/<timeStatType>", methods=['GET'])
def pythoncb7g1i62_news_value_riqi(xColumnName, yColumnName, timeStatType):
    '''
    按日期统计接口
    '''
    if request.method == 'GET':
...
# 按值统计（多）
@main_bp.route("/pythoncb7g1i62/news/valueMul/<xColumnName>", methods=['GET'])
def pythoncb7g1i62_news_valueMul(xColumnName):
...
# 按值统计（多）
@main_bp.route("/pythoncb7g1i62/news/valueMul/<xColumnName>/<timeStatType>", methods=['GET'])
def pythoncb7g1i62_news_valueMul_time(xColumnName,timeStatType):
...
# 推荐算法接口
@main_bp.route("/pythoncb7g1i62/news/autoSort2", methods=['GET'])
def pythoncb7g1i62_news_autoSort2():
    if request.method == 'GET':
...
# 统计接口
@main_bp.route("/pythoncb7g1i62/news/remind/<columnName>/<type>", methods=['GET'])  #
def pythoncb7g1i62_news_remind(columnName,type):
    '''
    '''
    if request.method == 'GET':
...
#分类列表
@main_bp.route("/pythoncb7g1i62/news/lists", methods=['GET'])
def pythoncb7g1i62_news_lists():
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success", "data": []}
