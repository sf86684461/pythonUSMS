...
# 注册接口
@main_bp.route("/pythoncb7g1i62/yonghu/register", methods=['POST'])
def pythoncb7g1i62_yonghu_register():
...
# 登录接口
@main_bp.route("/pythoncb7g1i62/yonghu/login", methods=['GET','POST'])
def pythoncb7g1i62_yonghu_login():
...
# 人脸登录接口
@main_bp.route("/pythoncb7g1i62/yonghu/faceLogin", methods=['GET','POST'])
def pythoncb7g1i62_yonghu_faceLogin():
    if request.method == 'GET' or request.method == 'POST':
        msg = {"code": normal_code, "msg": "success", "data": {}}
        req_dict = session.get("req_dict")
...
# 登出接口
@main_bp.route("/pythoncb7g1i62/yonghu/logout", methods=['POST'])
def pythoncb7g1i62_yonghu_logout():
    if request.method == 'POST':
        msg = {
            "msg": "退出成功",
            "code": 0
...
# 重置密码接口
@main_bp.route("/pythoncb7g1i62/yonghu/resetPass", methods=['POST'])
def pythoncb7g1i62_yonghu_resetpass():
    '''
    '''
    if request.method == 'POST':
...
# 获取会话信息接口
@main_bp.route("/pythoncb7g1i62/yonghu/session", methods=['GET'])
def pythoncb7g1i62_yonghu_session():
    '''
    '''
...
# 分类接口（后端）
@main_bp.route("/pythoncb7g1i62/yonghu/page", methods=['GET'])
def pythoncb7g1i62_yonghu_page():
    '''
    '''
    if request.method == 'GET':
...
# 排序接口
@main_bp.route("/pythoncb7g1i62/yonghu/autoSort", methods=['GET'])
def pythoncb7g1i62_yonghu_autosort():
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success",  "data":{"currPage":1,"totalPage":1,"total":1,"pageSize":10,"list":[]}}
...
#查询单条数据
@main_bp.route("/pythoncb7g1i62/yonghu/query", methods=['GET'])
def pythoncb7g1i62_yonghu_query():
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success",  "data":{}}
        req_dict = session.get("req_dict")
...
# 分页接口（前端）
@main_bp.route("/pythoncb7g1i62/yonghu/list", methods=['GET'])
def pythoncb7g1i62_yonghu_list():
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success",  "data":{"currPage":1,"totalPage":1,"total":1,"pageSize":10,"list":[]}}
...
# 保存接口（后端）
@main_bp.route("/pythoncb7g1i62/yonghu/save", methods=['POST'])
def pythoncb7g1i62_yonghu_save():
    '''
    '''
...
# 添加接口（前端）
@main_bp.route("/pythoncb7g1i62/yonghu/add", methods=['POST'])
def pythoncb7g1i62_yonghu_add():
    '''
    '''
    request.operation = "新增用户"
    if request.method == 'POST':
...
# 踩、赞接口
@main_bp.route("/pythoncb7g1i62/yonghu/thumbsup/<id_>", methods=['GET'])
def pythoncb7g1i62_yonghu_thumbsup(id_):
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 获取详情信息（后端）
@main_bp.route("/pythoncb7g1i62/yonghu/info/<id_>", methods=['GET'])
def pythoncb7g1i62_yonghu_info(id_):
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 获取详情信息（前端）
@main_bp.route("/pythoncb7g1i62/yonghu/detail/<id_>", methods=['GET'])
def pythoncb7g1i62_yonghu_detail(id_):
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 更新接口
@main_bp.route("/pythoncb7g1i62/yonghu/update", methods=['POST'])
def pythoncb7g1i62_yonghu_update():
    '''
    '''
...
# 删除接口
@main_bp.route("/pythoncb7g1i62/yonghu/delete", methods=['POST'])
def pythoncb7g1i62_yonghu_delete():
    '''
    '''
...
# 投票接口
@main_bp.route("/pythoncb7g1i62/yonghu/vote/<int:id_>", methods=['POST'])
def pythoncb7g1i62_yonghu_vote(id_):
    '''
    '''
    if request.method == 'POST':
        msg = {"code": normal_code, "msg": "success"}
...
# 分组统计接口
@main_bp.route("/pythoncb7g1i62/yonghu/group/<columnName>", methods=['GET'])
def pythoncb7g1i62_yonghu_group(columnName):
    '''
    分组统计接口
    '''
    if request.method == 'GET':
...
# 按值统计接口
@main_bp.route("/pythoncb7g1i62/yonghu/value/<xColumnName>/<yColumnName>", methods=['GET'])
def pythoncb7g1i62_yonghu_value(xColumnName, yColumnName):
    '''
    按值统计接口,
    {
        "code": 0,
...
# 按日期统计接口
@main_bp.route("/pythoncb7g1i62/yonghu/value/<xColumnName>/<yColumnName>/<timeStatType>", methods=['GET'])
def pythoncb7g1i62_yonghu_value_riqi(xColumnName, yColumnName, timeStatType):
    '''
    按日期统计接口
    '''
    if request.method == 'GET':
...
# 按值统计（多）
@main_bp.route("/pythoncb7g1i62/yonghu/valueMul/<xColumnName>", methods=['GET'])
def pythoncb7g1i62_yonghu_valueMul(xColumnName):
...
# 按值统计（多）
@main_bp.route("/pythoncb7g1i62/yonghu/valueMul/<xColumnName>/<timeStatType>", methods=['GET'])
def pythoncb7g1i62_yonghu_valueMul_time(xColumnName,timeStatType):
...
# 统计接口
@main_bp.route("/pythoncb7g1i62/yonghu/remind/<columnName>/<type>", methods=['GET'])  #
def pythoncb7g1i62_yonghu_remind(columnName,type):
    '''
    '''
    if request.method == 'GET':
...
#分类列表
@main_bp.route("/pythoncb7g1i62/yonghu/lists", methods=['GET'])
def pythoncb7g1i62_yonghu_lists():
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success", "data": []}
