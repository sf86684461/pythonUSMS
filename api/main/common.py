...
def before_request():
    ...
    if request.method == 'GET':
        get_list = [
            "/",
            "/apidocs/",
             "/pythoncb7g1i62/examusers/login" ,
            "/pythoncb7g1i62/examusers/register",
            '/pythoncb7g1i62/defaultuser/login',
            '/pythoncb7g1i62/users/login',
        ...
        post_list = [
            '/pythoncb7g1i62/defaultuser/register',
            '/pythoncb7g1i62/defaultuser/login',
            '/pythoncb7g1i62/users/register',
            '/pythoncb7g1i62/users/login',
            "/pythoncb7g1i62/examusers/login" ,
            "/pythoncb7g1i62/examusers/register"
        ]  # 免认证list
