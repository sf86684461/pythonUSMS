...
@main_bp.route("/pythoncb7g1i62/cal/<tableName>/<columnName>", methods=['GET'])
def pythoncb7g1i62_cal(tableName, columnName):
    '''
    计算规则接口
    '''
...
@main_bp.route("/pythoncb7g1i62/file/download", methods=['GET'])
def pythoncb7g1i62_file_download():
    '''
    '''
    if request.method == 'GET':
...
@main_bp.route("/pythoncb7g1i62/file/upload", methods=['POST'])
def pythoncb7g1i62_file_upload():
    '''
    '''
...
@main_bp.route("/pythoncb7g1i62/follow/<tableName>/<columnName>/<level>/<parent>", methods=['GET'])
def pythoncb7g1i62_follow_level(tableName, columnName, level,parent):
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, 'data': []}
...
@main_bp.route("/pythoncb7g1i62/follow/<tableName>/<columnName>", methods=['GET'])
def pythoncb7g1i62_follow(tableName, columnName):
    '''
...
@main_bp.route("/pythoncb7g1i62/location", methods=['GET'])
def pythoncb7g1i62_location():
    '''
...
@main_bp.route("/pythoncb7g1i62/matchFace", methods=['GET'])
def pythoncb7g1i62_matchface():
    '''
    baidubce百度人脸识别
    '''
    if request.method == 'GET':
...
@main_bp.route("/pythoncb7g1i62/option/<tableName>/<columnName>", methods=['GET'])
def pythoncb7g1i62_option(tableName, columnName):
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, 'data': []}
...
@main_bp.route("/pythoncb7g1i62/remind/<tableName>/<columnName>/<type>", methods=['GET'])  #
def pythoncb7g1i62_remind(tableName, columnName,type):
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, 'data': []}
...
@main_bp.route("/pythoncb7g1i62/sh/<tableName>", methods=['POST'])
def pythoncb7g1i62_sh(tableName):
    '''
    '''
    if request.method == 'POST':
        ...
        logging.warning("pythoncb7g1i62_sh.res=====>{}".format(res))
        return jsonify(msg)

@main_bp.route("/pythoncb7g1i62/upload/<fileName>", methods=['GET'])
def pythoncb7g1i62_upload(fileName):
    '''
    上传接口
    '''
    if request.method == 'GET':
...
@main_bp.route("/pythoncb7g1i62/group/<tableName>/<columnName>", methods=['GET'])
...
@main_bp.route("/pythoncb7g1i62/value/<tableName>/<xColumnName>/<yColumnName>", methods=['GET'])
