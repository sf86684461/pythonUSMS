<template>
	<div style="height: 100%;">
		<el-main :style='"vertical" == "vertical" ? (2 == 1 ? {"minHeight":"100%","padding":"0","margin":"0 0 0 210px","position":"relative","display":"block"} : (isCollapse ? {"minHeight":"100%","padding":"0","margin":"60px 0 0 0","position":"relative","background":"#f0f2f5","display":"block"} : {"minHeight":"100%","padding":"0 0 0 215px","margin":"60px 0 0 0","position":"inherit","background":"#f0f2f5","display":"block"})) : {"minHeight":"100%","margin":"0","position":"relative"}'>
			<!-- top -->
			<index-header :style='{"padding":"0 20px 0 20px","margin":"0","alignItems":"center","color":"#262626","display":"flex","justifyContent":"flex-end","top":"0","left":"0","background":"#fff","boxShadow":"0 1px 4px rgba(0,21,41,.08)","width":"calc(100% - 0px)","fontSize":"14px","position":"fixed","zIndex":"1000","height":"60px"}'></index-header>
			...
			<!-- breadcrumb -->
			<bread-crumbs :title="title" :style='{"padding":"0 16px","margin":"16px 16px 0","borderColor":"transparent","display":"block","background":"transparent","width":"auto","fontSize":"14px","position":"static","height":"auto","zIndex":"auto","borderWidth":"0"}' class="bread-crumbs"></bread-crumbs>
