...
<div>
	<div :style='{"padding":"20px 0","margin":"0px auto","borderColor":"#ddd","borderRadius":"0px","background":"none","borderWidth":"0 0 0px","width":"64%","borderStyle":"solid"}' class="breadcrumb-preview">
		<el-breadcrumb :separator="'='" :style='{"fontSize":"14px","lineHeight":"1","justifyContent":"flex-start","display":"flex"}'>
			...
			<el-breadcrumb-item class="item2" v-for="(item, index) in breadcrumbItem" :key="index" to="/index/shangpinjinhuo"><a>{{item.name}}</a></el-breadcrumb-item>
		...
		<div class="attr" :style='{"padding":"0","margin":"0","flexWrap":"wrap","background":"none","flex":"1","display":"flex","width":"48%","position":"relative","justifyContent":"space-between","order":"2"}'>
			...
			<div class="info" :style='{"minHeight":"340px","padding":"0px","margin":"0","flexWrap":"wrap","background":"none","display":"block","width":"100%","justifyContent":"space-between","order":"2"}'>
				...
				<div class="item" :style='{"padding":"0 0px","margin":"0 0 2px 0","borderColor":"#28890b10","background":"#fff","borderWidth":"0px","display":"flex","width":"100%","borderStyle":"solid","justifyContent":"spaceBetween"}'>
					<div class="lable" :style='{"width":"auto","padding":"0 5px 0 0","fontSize":"14px","lineHeight":"24px","color":"#333","textAlign":"right"}'>入库单号</div>
					<div  :style='{"padding":"0px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#999","flex":"1","height":"auto"}'>{{detail.rukudanhao}}</div>
				</div>
				<div class="item" :style='{"padding":"0 0px","margin":"0 0 2px 0","borderColor":"#28890b10","background":"#fff","borderWidth":"0px","display":"flex","width":"100%","borderStyle":"solid","justifyContent":"spaceBetween"}'>
					<div class="lable" :style='{"width":"auto","padding":"0 5px 0 0","fontSize":"14px","lineHeight":"24px","color":"#333","textAlign":"right"}'>商品名称</div>
					<div  :style='{"padding":"0px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#999","flex":"1","height":"auto"}'>{{detail.shangpinmingcheng}}</div>
				</div>
				<div class="item" :style='{"padding":"0 0px","margin":"0 0 2px 0","borderColor":"#28890b10","background":"#fff","borderWidth":"0px","display":"flex","width":"100%","borderStyle":"solid","justifyContent":"spaceBetween"}'>
				...
				<div class="item" :style='{"padding":"0 0px","margin":"0 0 2px 0","borderColor":"#28890b10","background":"#fff","borderWidth":"0px","display":"flex","width":"100%","borderStyle":"solid","justifyContent":"spaceBetween"}'>
					<div class="lable" :style='{"width":"auto","padding":"0 5px 0 0","fontSize":"14px","lineHeight":"24px","color":"#333","textAlign":"right"}'>入库价格</div>
					<div  :style='{"padding":"0px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#999","flex":"1","height":"auto"}'>{{detail.rukujiage}}</div>
				</div>
				<div class="item" :style='{"padding":"0 0px","margin":"0 0 2px 0","borderColor":"#28890b10","background":"#fff","borderWidth":"0px","display":"flex","width":"100%","borderStyle":"solid","justifyContent":"spaceBetween"}'>
					<div class="lable" :style='{"width":"auto","padding":"0 5px 0 0","fontSize":"14px","lineHeight":"24px","color":"#333","textAlign":"right"}'>入库总价</div>
					<div  :style='{"padding":"0px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#999","flex":"1","height":"auto"}'>{{detail.rukuzongjia}}</div>
				</div>
				<div class="item" :style='{"padding":"0 0px","margin":"0 0 2px 0","borderColor":"#28890b10","background":"#fff","borderWidth":"0px","display":"flex","width":"100%","borderStyle":"solid","justifyContent":"spaceBetween"}'>
				...
				<div class="item" :style='{"padding":"0 0px","margin":"0 0 2px 0","borderColor":"#28890b10","background":"#fff","borderWidth":"0px","display":"flex","width":"100%","borderStyle":"solid","justifyContent":"spaceBetween"}'>
					<div class="lable" :style='{"width":"auto","padding":"0 5px 0 0","fontSize":"14px","lineHeight":"24px","color":"#333","textAlign":"right"}'>入库时间</div>
					<div  :style='{"padding":"0px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#999","flex":"1","height":"auto"}'>{{detail.rukushijian}}</div>
				</div>
				<div class="item" :style='{"padding":"0 0px","margin":"0 0 2px 0","borderColor":"#28890b10","background":"#fff","borderWidth":"0px","display":"flex","width":"100%","borderStyle":"solid","justifyContent":"spaceBetween"}'>
					<div class="lable" :style='{"width":"auto","padding":"0 5px 0 0","fontSize":"14px","lineHeight":"24px","color":"#333","textAlign":"right"}'>员工工号</div>
					<div  :style='{"padding":"0px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#999","flex":"1","height":"auto"}'>{{detail.yuangonggonghao}}</div>
				</div>
				<div class="item" :style='{"padding":"0 0px","margin":"0 0 2px 0","borderColor":"#28890b10","background":"#fff","borderWidth":"0px","display":"flex","width":"100%","borderStyle":"solid","justifyContent":"spaceBetween"}'>
					<div class="lable" :style='{"width":"auto","padding":"0 5px 0 0","fontSize":"14px","lineHeight":"24px","color":"#333","textAlign":"right"}'>员工姓名</div>
					<div  :style='{"padding":"0px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#999","flex":"1","height":"auto"}'>{{detail.yuangongxingming}}</div>
				</div>
				<div class="item" :style='{"padding":"0 0px","margin":"0 0 2px 0","borderColor":"#28890b10","background":"#fff","borderWidth":"0px","display":"flex","width":"100%","borderStyle":"solid","justifyContent":"spaceBetween"}'>
					<div class="lable" :style='{"width":"auto","padding":"0 5px 0 0","fontSize":"14px","lineHeight":"24px","color":"#333","textAlign":"right"}'>备注</div>
					<div  :style='{"padding":"0px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#999","flex":"1","height":"auto"}'>{{detail.beizhu}}</div>
				</div>
				<div class="btn" :style='{"width":"100%","padding":"10px 0","flexWrap":"wrap","display":"flex"}'>
					<el-button :style='{"border":"0px solid #009cf530","cursor":"pointer","padding":"0 10px","margin":"0 5px 0 0","outline":"none","color":"#fff","borderRadius":"0px","background":"#009cf5","width":"auto","lineHeight":"36px","fontSize":"14px","height":"36px"}' v-if="btnAuth('shangpinjinhuo','修改')" @click="editClick">修改</el-button>
					<el-button :style='{"border":"0px solid #f5340030","cursor":"pointer","padding":"0 10px","margin":"0 5px 0 0","outline":"none","color":"#fff","borderRadius":"0px","background":"#f53400","width":"auto","lineHeight":"36px","fontSize":"14px","height":"36px"}' v-if="btnAuth('shangpinjinhuo','删除')" @click="delClick">删除</el-button>
					<el-button :style='{"border":"0px solid #f5340030","cursor":"pointer","padding":"0 10px","margin":"0 5px 0 0","outline":"none","color":"#fff","borderRadius":"0px","background":"#f53400","width":"auto","lineHeight":"36px","fontSize":"14px","height":"36px"}' v-if="btnAuth('shangpinjinhuo','私聊')&&detail.id!=mid" @click="chatClick">联系TA</el-button>
				</div>
			</div>
		</div>
    ...
    methods: {
      ...
      nextClick(page) {
		...
		backClick(){
			...
			this.$router.push({path: '/index/shangpinjinhuo', query: params});
		},
		// 下载
		download(file){
			if(!file) {
		...
		// 修改
		editClick(){
			this.$router.push(`/index/shangpinjinhuoAdd?type=edit&&id=${this.detail.id}`);
		},
		// 删除
		async delClick(){
			await this.$confirm('是否删除此商品进货？')
			  .then(_ => {
			    this.$http.post('shangpinjinhuo/delete', [this.detail.id]).then(async res => {
					if (res.data.code == 0) {
						this.$message({
							type: 'success',
							message: '删除成功!',
