	...
	<div class="main-containers">
		...
		<div class="top-container" :style='{"boxShadow":"0 0px 0px rgba(64, 158, 255, .3)","padding":"0px 40px","borderColor":"#ccc","alignItems":"center","color":"#666","textAlign":"right","display":"flex","justifyContent":"flex-end","overflow":"hidden","top":"0","borderRadius":"0","left":"0","background":"#fff","borderWidth":"0 0 2px","width":"100%","fontSize":"14px","lineHeight":"80px","position":"fixed","borderStyle":"solid","height":"80px","zIndex":"1002"}'>
			...
			<div :style='{"margin":"0","alignItems":"center","left":"20px","background":"none","display":"flex","width":"30%","position":"absolute","float":"left","height":"80px"}'>
			  <span @click="goMenu('/index/home')" :style='{"padding":"0px","color":"rgb(17, 19, 40)","alignItems":"center","display":"flex","width":"100%","lineHeight":"1.5","fontSize":"18px","fontWeight":"600","height":"100%"}'>无人超市管理系统</span>
			</div>
...
export default {
    data() {
		return {
            activeIndex: '0',
			roleMenus: [{"backMenu":[{"child":[{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-pic","buttons":["新增","查看","修改","删除"],"menu":"用户","menuJump":"列表","tableName":"yonghu"}],"menu":"用户管理"},{"child":[{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-goods","buttons":["新增","查看","修改","删除"],"menu":"员工","menuJump":"列表","tableName":"yuangong"}],"menu":"员工管理"},{"child":[{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-send","buttons":["新增","查看","修改","删除"],"menu":"商品分类","menuJump":"列表","tableName":"shangpinfenlei"}],"menu":"商品分类管理"},{"child":[{"allButtons":["新增","查看","修改","删除","库存统计","查看评论","进货"],"appFrontIcon":"cuIcon-copy","buttons":["新增","查看","修改","删除","库存统计","查看评论"],"menu":"超市商品","menuJump":"列表","tableName":"chaoshishangpin"}],"menu":"超市商品管理"},{"child":[{"allButtons":["新增","查看","修改","删除","日进货量统计"],"appFrontIcon":"cuIcon-similar","buttons":["查看","修改","删除","审核","日进货量统计","导出"],"menu":"商品进货","menuJump":"列表","tableName":"shangpinjinhuo"}],"menu":"商品进货管理"},{"child":[{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-form","buttons":["新增","查看","修改","删除"],"menu":"供应商","menuJump":"列表","tableName":"gongyingshang"}],"menu":"供应商管理"},{"child":[{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-list","buttons":["查看","修改"],"menu":"轮播图管理","tableName":"config"},{"allButtons":["查看","删除"],"appFrontIcon":"cuIcon-pay","buttons":["查看","删除"],"menu":"系统日志","tableName":"syslog"},{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-news","buttons":["新增","查看","修改","删除","查看评论"],"menu":"超市公告","tableName":"news"},{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-news","buttons":["新增","查看","修改","删除"],"menu":"超市公告分类","tableName":"newstype"},{"allButtons":["查看","修改"],"appFrontIcon":"cuIcon-clothes","buttons":["查看","修改"],"menu":"关于我们","tableName":"aboutus"},{"allButtons":["查看","修改"],"appFrontIcon":"cuIcon-present","buttons":["查看","修改"],"menu":"系统简介","tableName":"systemintro"},{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-send","buttons":["新增","查看","修改","删除"],"menu":"友情链接","tableName":"friendlink"}],"menu":"系统管理"},{"child":[{"allButtons":["新增","查看","修改","删除","导出","日销量","月销量","年销量","品销量","类销量","日销额","月销额","年销额","品销额","类销额"],"appFrontIcon":"cuIcon-camera","buttons":["查看"],"menu":"已取消订单","tableName":"orders/已取消"},{"allButtons":["新增","查看","修改","删除","导出","日销量","月销量","年销量","品销量","类销量","日销额","月销额","年销额","品销额","类销额","物流"],"appFrontIcon":"cuIcon-rank","buttons":["查看"],"menu":"已退款订单","tableName":"orders/已退款"},{"allButtons":["新增","查看","修改","删除","导出","日销量","月销量","年销量","品销量","类销量","日销额","月销额","年销额","品销额","类销额"],"appFrontIcon":"cuIcon-copy","buttons":["查看"],"menu":"未支付订单","tableName":"orders/未支付"},{"allButtons":["新增","查看","修改","删除","导出","日销量","月销量","年销量","品销量","类销量","日销额","月销额","年销额","品销额","类销额","发货","物流","核销"],"appFrontIcon":"cuIcon-discover","buttons":["查看","核销"],"menu":"已支付订单","tableName":"orders/已支付"},{"allButtons":["新增","查看","修改","删除","导出","日销量","月销量","年销量","品销量","类销量","日销额","月销额","年销额","品销额","类销额","物流","退货审核"],"appFrontIcon":"cuIcon-explore","buttons":["查看","退货审核","日销量","品销量","日销额","品销额"],"menu":"已完成订单","tableName":"orders/已完成"}],"menu":"订单管理"}],"frontMenu":[{"child":[{"allButtons":["新增","查看","修改","删除","库存统计","查看评论","进货"],"appFrontIcon":"cuIcon-copy","buttons":["查看"],"menu":"超市商品列表","menuJump":"列表","tableName":"chaoshishangpin"}],"menu":"超市商品模块"}],"hasBackLogin":"是","hasBackRegister":"否","hasFrontLogin":"否","hasFrontRegister":"否","roleName":"管理员","tableName":"users"},{"backMenu":[],"frontMenu":[{"child":[{"allButtons":["新增","查看","修改","删除","库存统计","查看评论","进货"],"appFrontIcon":"cuIcon-copy","buttons":["查看"],"menu":"超市商品列表","menuJump":"列表","tableName":"chaoshishangpin"}],"menu":"超市商品模块"}],"hasBackLogin":"否","hasBackRegister":"否","hasFrontLogin":"是","hasFrontRegister":"是","roleName":"用户","tableName":"yonghu"},{"backMenu":[{"child":[{"allButtons":["新增","查看","修改","删除","库存统计","查看评论","进货"],"appFrontIcon":"cuIcon-copy","buttons":["新增","查看","修改","删除","库存统计","查看评论","进货"],"menu":"超市商品","menuJump":"列表","tableName":"chaoshishangpin"}],"menu":"超市商品管理"},{"child":[{"allButtons":["新增","查看","修改","删除","日进货量统计"],"appFrontIcon":"cuIcon-similar","buttons":["查看"],"menu":"商品进货","menuJump":"列表","tableName":"shangpinjinhuo"}],"menu":"商品进货管理"},{"child":[{"allButtons":["新增","查看","修改","删除","导出","日销量","月销量","年销量","品销量","类销量","日销额","月销额","年销额","品销额","类销额","物流"],"appFrontIcon":"cuIcon-rank","buttons":["查看"],"menu":"已退款订单","tableName":"orders/已退款"},{"allButtons":["新增","查看","修改","删除","导出","日销量","月销量","年销量","品销量","类销量","日销额","月销额","年销额","品销额","类销额"],"appFrontIcon":"cuIcon-copy","buttons":["查看"],"menu":"未支付订单","tableName":"orders/未支付"},{"allButtons":["新增","查看","修改","删除","导出","日销量","月销量","年销量","品销量","类销量","日销额","月销额","年销额","品销额","类销额","发货","物流","核销"],"appFrontIcon":"cuIcon-discover","buttons":["查看","核销"],"menu":"已支付订单","tableName":"orders/已支付"},{"allButtons":["新增","查看","修改","删除","导出","日销量","月销量","年销量","品销量","类销量","日销额","月销额","年销额","品销额","类销额","物流","退货审核"],"appFrontIcon":"cuIcon-explore","buttons":["查看"],"menu":"已完成订单","tableName":"orders/已完成"},{"allButtons":["新增","查看","修改","删除","导出","日销量","月销量","年销量","品销量","类销量","日销额","月销额","年销额","品销额","类销额"],"appFrontIcon":"cuIcon-camera","buttons":["查看"],"menu":"已取消订单","tableName":"orders/已取消"}],"menu":"订单管理"}],"frontMenu":[{"child":[{"allButtons":["新增","查看","修改","删除","库存统计","查看评论","进货"],"appFrontIcon":"cuIcon-copy","buttons":["查看"],"menu":"超市商品列表","menuJump":"列表","tableName":"chaoshishangpin"}],"menu":"超市商品模块"}],"hasBackLogin":"是","hasBackRegister":"否","hasFrontLogin":"否","hasFrontRegister":"否","roleName":"员工","tableName":"yuangong"}],
			baseUrl: '',
			carouselList: [],
			menuList: [],
			form: {
